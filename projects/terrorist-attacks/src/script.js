 ...
 function resize() {
     ...
     sizeLegend.attr("transform", `translate(${margin.left}, 0)`);
 ...
 d3.json("./us_terr_data/terr.json", function (error, data) {
     ...
     function drawChart() {
         ...
         bounds.selectAll('.point').remove()
         bounds.selectAll('.link').remove()
         bounds.selectAll('.node').remove()
         grids.selectAll('*').remove()
         nan.selectAll('*').remove()
         small.selectAll('*').remove()
         medium.selectAll('*').remove()
         large.selectAll('*').remove()
         dashedLegend.selectAll('*').remove()
     ...
     var source = d3.select(".data-source-container")
